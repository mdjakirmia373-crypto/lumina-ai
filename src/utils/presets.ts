...
export const STYLE_PRESETS: StylePreset[] = [
  ...
  },
  {
    ...
    promptSuffix: ', highly detailed, 8k resolution, photorealistic, cinematic lighting, sharp focus, professional photography, Hasselblad camera',
    icon: 'Camera',
  },
  {
    id: 'anime',
    ...
    nameEn: 'Anime / Manga',
    promptSuffix: ', vibrant anime style, studio ghibli and makoto shinkai aesthetic, gorgeous line art, colorful aesthetic, high quality illustration',
    icon: 'Palette',
  },
  {
    id: '3d-render',
    ...
    promptSuffix: ', cute 3D Pixar Disney animated movie character render, unreal engine 5, octane render, smooth volumetric lighting, adorable detailing',
    icon: 'Box',
  },
  {
    id: 'cyberpunk',
    ...
    promptSuffix: ', cyberpunk aesthetic, glowing neon lights, rain reflections, futuristic tech, synthwave vibes, dark atmospheric cinematic',
    icon: 'Zap',
  },
  {
    id: 'digital-art',
    ...
    promptSuffix: ', epic digital concept art, trending on artstation, masterpiece, intricate details, vivid atmospheric colors, breathtaking composition',
    icon: 'Brush',
  },
  {
    id: 'oil-painting',
    ...
    promptSuffix: ', classical oil on canvas painting, visible textured brushstrokes, fine art masterpiece, dramatic chiaroscuro lighting',
    icon: 'Feather',
  },
  {
    id: 'cinematic',
    ...
    promptSuffix: ', 35mm film still, Kodak Portra 400 color grading, cinematic depth of field, anamorphic lens flare, movie shot',
    icon: 'Film',
  },
];
